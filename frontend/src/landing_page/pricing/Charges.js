  ...
  return (
    <div className="container page">
      <div className="row p-5">
        <h4 className="heading-dark ">Charges explained</h4>
        ...
        <div className="col text-muted p-3">
          ...
          <p>
            ...
            than ₹4,00,000. To learn more about BSDA, Click her
          ...
          <h6>Off-market transfer charges</h6> <p>₹25 per transaction.</p>{" "}
